<template>
  ...
  <svg v-else-if="name === 'tag'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M17.63 7.63l-6.25-6.25A2 2 0 0 0 10.07 1H3a2 2 0 0 0-2 2v7.07a2 2 0 0 0 .59 1.41l6.25 6.25a2 2 0 0 0 2.83 0l7.86-7.86a2 2 0 0 0 0-2.83zM5 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/></svg>
  <svg v-else-if="name === 'shopping-bag'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M6 2h8l2 4v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6l2-4zm4 4a2 2 0 0 1 2 2h-4a2 2 0 0 1 2-2z"/></svg>
